...
You can access jupyter lab at `<host-ip>:<port>/lab/workspaces/lab6_Decision`
...
The training algorithm compares all features (or less if `max_features`
