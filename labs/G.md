...
::: {.section data-type="sect1" pdf-bookmark="TF Functions and Concrete Functions"}
::: {#idm45728429510056 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Exploring Function Definitions and Graphs"}
::: {#idm45728429385304 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="A Closer Look at Tracing"}
::: {#idm45728429384680 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Using AutoGraph to Capture Control Flow"}
::: {#idm45728428738504 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Handling Variables and Other Resources in TF Functions"}
::: {#idm45728428732616 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Using TF Functions with tf.keras (or Not)"}
::: {#idm45728428627720 .sect1}
