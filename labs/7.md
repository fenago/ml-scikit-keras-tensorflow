...
[Chapter 7. ]{.label}Ensemble Learning and Random Forests
=========================================================
...
::: {.section data-type="sect1" pdf-bookmark="Voting Classifiers"}
::: {#idm45728479537176 .sect1}
Voting Classifiers
==================
...
![](./7_files/mls2_0701.png){width="1441" height="618"}
...
![](./7_files/mls2_0702.png){width="1441" height="767"}
...
![](./7_files/mls2_0703.png){width="1441" height="579"}
...
::: {.section data-type="sect1" pdf-bookmark="Bagging and Pasting"}
::: {#idm45728479399160 .sect1}
Bagging and Pasting
===================
...
![](./7_files/mls2_0704.png){width="1440" height="727"}
...
::: {.section data-type="sect2" pdf-bookmark="Bagging and Pasting in Scikit-Learn"}
::: {#idm45728479319368 .sect2}
...
![](./7_files/mls2_0705.png){width="1440" height="542"}
...
::: {.section data-type="sect2" pdf-bookmark="Out-of-Bag Evaluation"}
::: {#idm45728479227640 .sect2}
...
::: {.section data-type="sect1" pdf-bookmark="Random Patches and Random Subspaces"}
::: {#idm45728479227144 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Random Forests"}
::: {#idm45728479035672 .sect1}
Random Forests
==============
...
::: {.section data-type="sect2" pdf-bookmark="Extra-Trees"}
::: {#idm45728478942456 .sect2}
Extra-Trees
-----------
...
::: {.section data-type="sect2" pdf-bookmark="Feature Importance"}
::: {#idm45728478888728 .sect2}
Feature Importance
------------------
...
![](./7_files/mls2_0706.png){width="1440" height="988"}
...
::: {.section data-type="sect1" pdf-bookmark="Boosting"}
::: {#idm45728478786936 .sect1}
Boosting
========
...
::: {.section data-type="sect2" pdf-bookmark="AdaBoost"}
::: {#idm45728478777752 .sect2}
AdaBoost
--------
...
![](./7_files/mls2_0707.png){width="1439" height="842"}
...
![](./7_files/mls2_0708.png){width="1440" height="543"}
...
::: {#weighted_error_rate data-type="equation"}
##### [Equation 7-1. ]{.label}Weighted error rate of the j^th^ predictor
...
::: {#predictor_weight data-type="equation"}
##### [Equation 7-2. ]{.label}Predictor weight
...
::: {#instance_weight_update data-type="equation"}
##### [Equation 7-3. ]{.label}Weight update rule
...
::: {#adaboost_prediction data-type="equation"}
##### [Equation 7-4. ]{.label}AdaBoost predictions
...
::: {.section data-type="sect2" pdf-bookmark="Gradient Boosting"}
::: {#idm45728478776808 .sect2}
Gradient Boosting
-----------------
...
![](./7_files/mls2_0709.png){width="1440" height="1457"}
...
![](./7_files/mls2_0710.png){width="1440" height="555"}
...
![](./7_files/mls2_0711.png){width="1440" height="559"}
...
::: {.section data-type="sect1" pdf-bookmark="Stacking"}
::: {#idm45728478549608 .sect1}
Stacking
========
...
![](./7_files/mls2_0712.png){width="1441" height="1269"}
...
![](./7_files/mls2_0713.png){width="1440" height="926"}
...
![](./7_files/mls2_0714.png){width="1439" height="1436"}
...
![](./7_files/mls2_0715.png){width="1346" height="1391"}
