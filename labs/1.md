...
::: {.section data-type="sect1" pdf-bookmark="What Is Machine Learning?"}
::: {#what_is_machine_learning .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Why Use Machine Learning?"}
::: {#idm45728493867768 .sect1}
...
![](./1_files/mls2_0104.png){width="1440" height="847"}
...
::: {.section data-type="sect1" pdf-bookmark="Examples of Applications"}
::: {#idm45728493867144 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Types of Machine Learning Systems"}
::: {#idm45728493800264 .sect1}
...
::: {.section data-type="sect2" pdf-bookmark="Supervised/Unsupervised Learning"}
::: {#idm45728493792456 .sect2}
...
::: {.section data-type="sect3" pdf-bookmark="Supervised learning"}
::: {#idm45728493789800 .sect3}
### Supervised learning
...
::: {.section data-type="sect3" pdf-bookmark="Unsupervised learning"}
::: {#idm45728493789208 .sect3}
...
::: {.section data-type="sect3" pdf-bookmark="Semisupervised learning"}
::: {#idm45728493753448 .sect3}
...
::: {.section data-type="sect3" pdf-bookmark="Reinforcement Learning"}
::: {#idm45728493682072 .sect3}
...
::: {.section data-type="sect2" pdf-bookmark="Batch and Online Learning"}
::: {#idm45728493670488 .sect2}
...
::: {.section data-type="sect3" pdf-bookmark="Batch learning"}
::: {#idm45728493668904 .sect3}
### Batch learning
...
::: {.section data-type="sect3" pdf-bookmark="Online learning"}
::: {#idm45728493659240 .sect3}
### Online learning
...
::: {.section data-type="sect2" pdf-bookmark="Instance-Based Versus Model-Based Learning"}
::: {#idm45728493639320 .sect2}
...
::: {.section data-type="sect3" pdf-bookmark="Instance-based learning"}
::: {#idm45728493635528 .sect3}
...
::: {.section data-type="sect3" pdf-bookmark="Model-based learning"}
::: {#model_based_learning .sect3}
...
::: {#a_simple_linear_model data-type="equation"}
...
![](./1_files/mls2_0118.png){width="1408" height="801"}
...
::: {#example_scikit_code data-type="example"}
...
::: {.section data-type="sect1" pdf-bookmark="Main Challenges of Machine Learning"}
::: {#idm45728493625528 .sect1}
...
::: {.section data-type="sect2" pdf-bookmark="Insufficient Quantity of Training Data"}
::: {#idm45728493347720 .sect2}
...
::: {.section data-type="sect2" pdf-bookmark="Nonrepresentative Training Data"}
::: {#idm45728493311800 .sect2}
...
![](./1_files/mls2_0121.png){width="1440" height="502"}
...
::: {.section data-type="sect2" pdf-bookmark="Poor-Quality Data"}
::: {#idm45728493292520 .sect2}
Poor-Quality Data
-----------------
...
::: {.section data-type="sect2" pdf-bookmark="Irrelevant Features"}
::: {#idm45728493286744 .sect2}
Irrelevant Features
-------------------
...
::: {.section data-type="sect2" pdf-bookmark="Overfitting the Training Data"}
::: {#idm45728493276456 .sect2}
...
::: {.section data-type="sect2" pdf-bookmark="Underfitting the Training Data"}
::: {#idm45728493211240 .sect2}
...
::: {.section data-type="sect2" pdf-bookmark="Stepping Back"}
::: {#idm45728493174440 .sect2}
Stepping Back
-------------
...
::: {.section data-type="sect1" pdf-bookmark="Testing and Validating"}
::: {#idm45728493164168 .sect1}
...
::: {.section data-type="sect2" pdf-bookmark="Hyperparameter Tuning and Model Selection"}
::: {#idm45728493151000 .sect2}
...
::: {.section data-type="sect2" pdf-bookmark="Data Mismatch"}
::: {#idm45728493135576 .sect2}
Data Mismatch
-------------
