...
You can access jupyter lab at `<host-ip>:<port>/lab/workspaces/lab14_Computer_Vision`
...
![mls2 1406](./images/mls2_1406.png)
...
![mls2 1410](./images/mls2_1410.png)
...
![mls2 1411](./images/mls2_1411.png)
...
![mls2 1417](./images/mls2_1417.png)
...
![mls2 1418](./images/mls2_1418.png)
...
![mls2 1420](./images/mls2_1420.png)
...
![mls2 1421](./images/mls2_1421.png)
...
As you can see, this code matches
[Figure 14-18]
...
![mls2 1425](./images/mls2_1425.png)
...
![mls2 1428](./images/mls2_1428.png)
...
paper](https://homl.info/maskrcnn): ^[34]
...
2.  Consider a CNN composed of three convolutional layers, each with 3 ×
    ...
    What is the total number of parameters in the CNN? If we are using
    32-bit floats, at least how much RAM will this network require when
    making a prediction for a single instance? What about when training
    on a mini-batch of 50 images?
...
10. Use transfer learning for large image classification, going through
    ...
    1.  Create a training set containing at least 100 images per class.
        For example, you could classify your own pictures based on the
        location (beach, mountain, city, etc.), or alternatively you can
        use an existing dataset (e.g., from TensorFlow Datasets).

    2.  Split it into a training set, a validation set, and a test set.

    3.  Build the input pipeline, including the appropriate
        preprocessing operations, and optionally add data augmentation.

    4.  Fine-tune a pretrained model on this dataset.

11. Go through TensorFlow’s [Style Transfer
