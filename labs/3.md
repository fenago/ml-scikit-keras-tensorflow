...
[Chapter 3. ]{.label}Classification
===================================
...
::: {.section data-type="sect1" pdf-bookmark="MNIST"}
::: {#idm45728488576328 .sect1}
MNIST
=====
...
![](./3_files/mls2_03in01.png){width="731" height="730"}
...
![](./3_files/mls2_0301.png){width="1439" height="1450"}
...
::: {.section data-type="sect1" pdf-bookmark="Training a Binary Classifier"}
::: {#idm45728488575416 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Performance Measures"}
::: {#idm45728488195512 .sect1}
...
::: {.section .pagebreak-before .less_space data-type="sect2" pdf-bookmark="Measuring Accuracy Using Cross-Validation"}
::: {#idm45728488177992 .sect2}
...
::: {.section data-type="sect2" pdf-bookmark="Confusion Matrix"}
::: {#idm45728488177400 .sect2}
Confusion Matrix
----------------
...
::: {#equation_three_one data-type="equation"}
##### [Equation 3-1. ]{.label}Precision
...
::: {#equation_three_two data-type="equation"}
##### [Equation 3-2. ]{.label}Recall
...
![](./3_files/mls2_0302.png){width="1439" height="683"}
:::
:::

::: {.section data-type="sect2" pdf-bookmark="Precision and Recall"}
::: {#idm45728487862632 .sect2}
...
::: {#equation_three_three data-type="equation"}
##### [Equation 3-3. ]{.label}F~1~
...
::: {.section data-type="sect2" pdf-bookmark="Precision/Recall Trade-off"}
::: {#idm45728487648744 .sect2}
...
![](./3_files/mls2_0303.png){width="1441" height="401"}
...
![](./3_files/mls2_0304.png){width="1440" height="685"}
...
![](./3_files/mls2_0305.png){width="1440" height="1058"}
...
::: {.section data-type="sect2" pdf-bookmark="The ROC Curve"}
::: {#idm45728487558200 .sect2}
The ROC Curve
-------------
...
(recall) versus [1 -- *specificity*]{.keep-together}.
...
![](./3_files/mls2_0306.png){width="1441" height="1055"}
...
![](./3_files/mls2_0307.png){width="1441" height="1055"}
...
::: {.section data-type="sect1" pdf-bookmark="Multiclass Classification"}
::: {#idm45728487174008 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Error Analysis"}
::: {#idm45728486381944 .sect1}
Error Analysis
==============
...
![](./3_files/mls2_03in02.png){width="991" height="1023"}
...
![](./3_files/mls2_03in03.png){width="991" height="1023"}
...
![](./3_files/mls2_03in04.png){width="1439" height="1433"}
...
::: {.section data-type="sect1" pdf-bookmark="Multilabel Classification"}
::: {#idm45728486358776 .sect1}
...
::: {.section data-type="sect1" pdf-bookmark="Multioutput Classification"}
::: {#idm45728485973432 .sect1}
...
![](./3_files/mls2_03in05.png){width="1441" height="681"}
...
![](./3_files/mls2_03in06.png){width="658" height="730"}
