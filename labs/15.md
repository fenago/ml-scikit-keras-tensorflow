...
[Chapter 15. ]{.label}Processing Sequences Using [RNNs and CNNs]{.keep-together}
================================================================================
...
::: {.section data-type="sect1" pdf-bookmark="Recurrent Neurons and Layers"}
::: {#idm45728453105336 .sect1}
...
![](./15_files/mls2_1501.png){width="1363" height="594"}
...
![](./15_files/mls2_1502.png){width="1441" height="549"}
...
::: {#rnn_output_equation data-type="equation"}
##### [Equation 15-1. ]{.label}Output of a recurrent layer for a single instance
...
::: {#rnn_output_vectorized_equation data-type="equation"}
##### [Equation 15-2. ]{.label}Outputs of a layer of recurrent neurons for all instances in a mini-batch
...
::: {.section data-type="sect2" pdf-bookmark="Memory Cells"}
::: {#idm45728452981560 .sect2}
Memory Cells
------------
...
![](./15_files/mls2_1503.png){width="1095" height="513"}
:::
:::

::: {.section data-type="sect2" pdf-bookmark="Input and Output Sequences"}
::: {#idm45728452952008 .sect2}
...
![](./15_files/mls2_1504.png){width="1440" height="965"}
...
::: {.section data-type="sect1" pdf-bookmark="Training RNNs"}
::: {#idm45728453104744 .sect1}
Training RNNs
=============
...
![](./15_files/mls2_1505.png){width="1091" height="662"}
...
::: {.section data-type="sect1" pdf-bookmark="Forecasting a Time Series"}
::: {#idm45728452909240 .sect1}
...
![](./15_files/mls2_1506.png){width="1439" height="447"}
...
::: {.section data-type="sect2" pdf-bookmark="Baseline Metrics"}
::: {#idm45728452634152 .sect2}
Baseline Metrics
----------------
...
::: {.section data-type="sect2" pdf-bookmark="Implementing a Simple RNN"}
::: {#idm45728452520936 .sect2}
...
::: {.section data-type="sect2" pdf-bookmark="Deep RNNs"}
::: {#idm45728452439544 .sect2}
Deep RNNs
---------
...
![](./15_files/mls2_1507.png){width="1439" height="812"}
...
::: {.section data-type="sect2" pdf-bookmark="Forecasting Several Time Steps Ahead"}
::: {#idm45728452438920 .sect2}
...
![](./15_files/mls2_1508.png){width="1440" height="918"}
...
::: {.section data-type="sect1" pdf-bookmark="Handling Long Sequences"}
::: {#idm45728451745512 .sect1}
...
::: {.section data-type="sect2" pdf-bookmark="Fighting the Unstable Gradients Problem"}
::: {#idm45728451655880 .sect2}
...
::: {.section data-type="sect2" pdf-bookmark="Tackling the Short-Term Memory Problem"}
::: {#idm45728451655288 .sect2}
...
::: {.section data-type="sect3" pdf-bookmark="LSTM cells"}
::: {#idm45728451443448 .sect3}
### LSTM cells
...
![](./15_files/mls2_1509.png){width="1438" height="859"}
...
::: {#lstm_equation data-type="equation"}
##### [Equation 15-3. ]{.label}LSTM computations
...
::: {.section data-type="sect3" pdf-bookmark="Peephole connections"}
::: {#idm45728451442856 .sect3}
...
::: {.section data-type="sect3" pdf-bookmark="GRU cells"}
::: {#idm45728450947800 .sect3}
### GRU cells
...
![](./15_files/mls2_1510.png){width="1440" height="979"}
...
::: {#gru_equation data-type="equation"}
##### [Equation 15-4. ]{.label}GRU computations
...
::: {.section data-type="sect3" pdf-bookmark="Using 1D convolutional layers to process sequences"}
::: {#idm45728450842856 .sect3}
...
::: {.section data-type="sect3" pdf-bookmark="WaveNet"}
::: {#idm45728450833224 .sect3}
### WaveNet
...
![](./15_files/mls2_1511.png){width="1441" height="555"}
