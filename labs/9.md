...
[Chapter 9. ]{.label}Unsupervised Learning Techniques
=====================================================
...
::: {.section data-type="sect1" pdf-bookmark="Clustering"}
::: {#idm45728476469000 .sect1}
Clustering
==========
...
![](./9_files/mls2_0901.png){width="1440" height="521"}
...
::: {.section data-type="sect2" pdf-bookmark="K-Means"}
::: {#idm45728476427192 .sect2}
K-Means
-------
...
![](./9_files/mls2_0902.png){width="1441" height="680"}
...
![](./9_files/mls2_0903.png){width="1441" height="680"}
...
::: {.section data-type="sect3" pdf-bookmark="The K-Means algorithm"}
::: {#idm45728476221640 .sect3}
...
![](./9_files/mls2_0904.png){width="1441" height="1142"}
...
![](./9_files/mls2_0905.png){width="1441" height="432"}

Let's look at a few ways you can mitigate this risk by improving the
centroid [initialization]{.keep-together}.
:::
:::

::: {.section data-type="sect3" pdf-bookmark="Centroid initialization methods"}
::: {#idm45728476185544 .sect3}
...
::: {.section data-type="sect3" pdf-bookmark="Accelerated K-Means and mini-batch K-Means"}
::: {#idm45728476184888 .sect3}
...
![](./9_files/mls2_0906.png){width="1440" height="540"}
:::
:::

::: {.section data-type="sect3" pdf-bookmark="Finding the optimal number of clusters"}
::: {#idm45728475954936 .sect3}
...
![](./9_files/mls2_0907.png){width="1441" height="424"}
...
![](./9_files/mls2_0908.png){width="1439" height="579"}
...
[*silhouette score*]{.keep-together}, which is the mean *silhouette
coefficient* over all the instances. An [instance's]{.keep-together}
...
![](./9_files/mls2_0909.png){width="1440" height="491"}
...
![](./9_files/mls2_0910.png){width="1440" height="1164"}
...
::: {.section data-type="sect2" pdf-bookmark="Limits of K-Means"}
::: {#idm45728476426376 .sect2}
Limits of K-Means
-----------------
...
![](./9_files/mls2_0911.png){width="1440" height="426"}
...
::: {.section data-type="sect2" pdf-bookmark="Using Clustering for Image Segmentation"}
::: {#idm45728475841464 .sect2}
...
![](./9_files/mls2_0912.png){width="1441" height="717"}
...
::: {.section data-type="sect2" pdf-bookmark="Using Clustering for Preprocessing"}
::: {#idm45728475840872 .sect2}
...
::: {.section data-type="sect2" pdf-bookmark="Using Clustering for Semi-Supervised Learning"}
::: {#idm45728475723464 .sect2}
...
![](./9_files/mls2_0913.png){width="1440" height="367"}
...
::: {.section data-type="sect2" pdf-bookmark="DBSCAN"}
::: {#idm45728475357192 .sect2}
DBSCAN
------
...
![](./9_files/mls2_0914.png){width="1440" height="475"}
...
![](./9_files/mls2_0915.png){width="1441" height="666"}
...
::: {.section data-type="sect2" pdf-bookmark="Other Clustering Algorithms"}
::: {#idm45728474803224 .sect2}
...
::: {.section data-type="sect1" pdf-bookmark="Gaussian Mixtures"}
::: {#idm45728476468376 .sect1}
Gaussian Mixtures
=================
...
![](./9_files/mls2_0916.png){width="1440" height="759"}
...
instances. [During]{.keep-together} the maximization step, each
...
![](./9_files/mls2_0917.png){width="1440" height="682"}
...
![](./9_files/mls2_0918.png){width="1439" height="608"}
...
::: {.section data-type="sect2" pdf-bookmark="Anomaly Detection Using Gaussian Mixtures"}
::: {#idm45728473926232 .sect2}
...
![](./9_files/mls2_0919.png){width="1440" height="682"}
...
::: {.section data-type="sect2" pdf-bookmark="Selecting the Number of Clusters"}
::: {#idm45728473886888 .sect2}
...
::: {#information_criteria_equation data-type="equation"}
##### [Equation 9-1. ]{.label}Bayesian information criterion (BIC) and Akaike information criterion (AIC)
...
![](./9_files/mls2_0920.png){width="1440" height="779"}
...
![](./9_files/mls2_0921.png){width="1439" height="484"}
:::
:::

::: {.section data-type="sect2" pdf-bookmark="Bayesian Gaussian Mixture Models"}
::: {#idm45728473886264 .sect2}
...
![](./9_files/mls2_0922.png){width="1440" height="777"}
...
![](./9_files/mls2_0923.png){width="1440" height="618"}
...
::: {#bayes_theorem_equation data-type="equation"}
##### [Equation 9-2. ]{.label}Bayes' theorem
...
::: {#evidence_integral_equation data-type="equation"}
##### [Equation 9-3. ]{.label}The evidence *p*(**X**) is often intractable
...
from *q*(**z**) to [*p*(**z**\|**X**]{.keep-together}), noted
...
::: {#variational_kl_divergence_equation data-type="equation"}
##### [Equation 9-4. ]{.label}KL divergence from *q*(**z**) to *p*(**z**\|**X**)
...
![](./9_files/mls2_0924.png){width="1440" height="468"}
...
::: {.section data-type="sect2" pdf-bookmark="Other Algorithms for Anomaly and Novelty Detection"}
::: {#idm45728473739544 .sect2}
...
:   This[]{#idm45728473405928}[]{#idm45728473405192} algorithm is better
    ...
    large [datasets]{.keep-together}.[]{#idm45728473401688}
:::
:::
:::
:::
